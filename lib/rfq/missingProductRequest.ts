  ...
  return [
    {
      ...
      body: `เรียนลูกค้า\n\nMRT Supplier ได้รับคำขอสินค้าที่ค้นหาไม่เจอสำหรับรายการ ${reference} เรียบร้อยแล้ว ขณะนี้ทีมงานกำลังตรวจสอบสเปกและดำเนินการเทียบเบอร์ให้โดยเร็ว\n\nหากมีข้อมูลเพิ่มเติมที่ต้องการแจ้ง สามารถส่งกลับมาได้ตลอดครับ/ค่ะ\n\nขอบพระคุณครับ/ค่ะ`,
    },
    {
      id: "need-more-info",
