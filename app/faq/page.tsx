...
import { ChevronDown, Search, FileText, PackageCheck, RefreshCw } from "lucide-react";
...
const sections: FAQSection[] = [
  ...
  },
  {
    ...
    icon: RefreshCw,
    description:
      "What happens after search, quote request, and follow-up.",
    items: [
      {
      ...
      <section className="border-b border-neutral-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-10 md:py-14">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-neutral-600 md:text-base">
            Answers to common questions about industrial part search, cross reference,
            RFQ workflow, and product sourcing on MRT Supplier.
          </p>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-sm leading-6 text-neutral-600">
                ...
                search first. If you need pricing or sourcing support for one
                or more items, send your RFQ directly.
              </p>
            </div>
